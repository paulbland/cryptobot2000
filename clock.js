...
// every minute!
new CronJob('5 * * * * *', function() { liveBot.run('30_day_bot') }, null, true, config.timezone); 
new CronJob('15 * * * * *', function() { liveBot.run('60_day_bot') }, null, true, config.timezone); 
new CronJob('25 * * * * *', function() { liveBot.run('90_day_bot') }, null, true, config.timezone); 
new CronJob('35 * * * * *', function() { liveBot.run('120_day_bot') }, null, true, config.timezone); 
new CronJob('45 * * * * *', function() { liveBot.run('150_day_bot') }, null, true, config.timezone); 
new CronJob('55 * * * * *', function() { liveBot.run('180_day_bot') }, null, true, config.timezone); 
