module.exports = {
	...
	low_values : {
		...
		'45_days' 	: genValues(0.040, 0.200, 0.01, 3),  //   "
	...
	high_values : {
		...
		'45_days' 	: genValues(0.090, 0.300, 0.01, 3),  //   "
		'60_days' 	: genValues(0.180, 0.320, 0.01, 3),  
		'75_days' 	: genValues(0.180, 0.280, 0.01, 3),  
		'90_days' 	: genValues(0.180, 0.290, 0.01, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 26, 1, 1), // was 0.5
		'45_days' 	: genCombos(12, 28, 1, 1), //   "
