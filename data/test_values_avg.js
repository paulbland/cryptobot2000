module.exports = {
	...
	low_values : {
		'30_days' 	: genValues(0.100, 0.145, 0.005, 3), // done
		'45_days' 	: genValues(0.145, 0.175, 0.005, 3), // done
	...
	high_values : {
		'30_days' 	: genValues(0.150, 0.270, 0.005, 3),  // done
		'45_days' 	: genValues(0.205, 0.235, 0.005, 3),  // done
	...
	period_offset : {
		...
		'45_days' 	: genCombos(16, 19.5, 0.5, 1), // done
