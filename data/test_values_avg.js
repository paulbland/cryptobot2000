module.exports = {
	...
	low_values : {
		...
		'60_days' 	: genValues(0.150, 0.190, 0.005, 3), 
		'75_days' 	: genValues(0.120, 0.150, 0.005, 3),
		'90_days' 	: genValues(0.075, 0.100, 0.005, 3)
	},
	high_values : {
		'15_days' 	: genValues(0.130, 0.165, 0.005, 3), 
		'30_days' 	: genValues(0.170, 0.205, 0.005, 3),  
		'45_days' 	: genValues(0.175, 0.205, 0.005, 3),  
		'60_days' 	: genValues(0.175, 0.205, 0.005, 3), 
		'75_days' 	: genValues(0.165, 0.190, 0.005, 3), 
		'90_days' 	: genValues(0.160, 0.190, 0.005, 3)
	},
	period_offset : {
		...
		'75_days' 	: genCombos(9.5, 13.5, 0.5, 1),
		'90_days' 	: genCombos(9.5, 13, 0.5, 1)
	}
}	
