module.exports = {
	...
	low_values : {
		'30_days' 	: genValues(0.050, 0.145, 0.005, 3), 
		'45_days' 	: genValues(0.050, 0.175, 0.005, 3), //genValues(0.115, 0.175, 0.005, 3), 
		'60_days' 	: genValues(0.145, 0.175, 0.005, 3), 
		'75_days' 	: genValues(0.150, 0.185, 0.005, 3), 
		'90_days' 	: genValues(0.135, 0.200, 0.005, 3)  
	},
	high_values : {
		'30_days' 	: genValues(0.115, 0.275, 0.005, 3), 
		'45_days' 	: genValues(0.150, 0.275, 0.005, 3), //genValues(0.195, 0.275, 0.005, 3), 
		'60_days' 	: genValues(0.180, 0.235, 0.005, 3),  
		'75_days' 	: genValues(0.180, 0.230, 0.005, 3),  
		'90_days' 	: genValues(0.185, 0.230, 0.005, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17.5, 23.5, 0.5, 1), 
		'45_days' 	: genCombos(13, 22, 0.5, 1), // genCombos(13, 20.5, 0.5, 1), 
		'60_days' 	: genCombos(16, 19.5, 0.5, 1), 
		'75_days' 	: genCombos(16.5, 19.5, 0.5, 1), 	 
