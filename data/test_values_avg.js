module.exports = {
	...
	low_values : {
		...
		'45_days' 	: genValues(0.040, 0.220, 0.01, 3),  //   "
	...
	high_values : {
		...
		'45_days' 	: genValues(0.090, 0.320, 0.01, 3),  //   "
		'60_days' 	: genValues(0.180, 0.340, 0.01, 3),  
		'75_days' 	: genValues(0.180, 0.300, 0.01, 3),  
		'90_days' 	: genValues(0.180, 0.310, 0.01, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 28, 1, 1), // was 0.5
