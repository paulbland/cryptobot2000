module.exports = {
	...
	low_values : {
		...
		'75_days' 	: genValues(0.135, 0.185, 0.005, 3), 
		'90_days' 	: genValues(0.130, 0.200, 0.005, 3)  
	},
	high_values : {
		'30_days' 	: genValues(0.095, 0.275, 0.01, 3),  // was 0.005
		'45_days' 	: genValues(0.115, 0.280, 0.01, 3),  // was 0.005
		'60_days' 	: genValues(0.180, 0.280, 0.005, 3),  
		'75_days' 	: genValues(0.180, 0.245, 0.005, 3),  
		'90_days' 	: genValues(0.180, 0.250, 0.005, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 24, 0.5, 1), 
		'45_days' 	: genCombos(12.5, 24.5, 0.5, 1), 
