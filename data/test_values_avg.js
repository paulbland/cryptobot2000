module.exports = {
	...
	low_values : {
		'15_days' 	: genValues(0.105, 0.130, 0.005, 3),
		'30_days' 	: genValues(0.130, 0.160, 0.005, 3),
		'45_days' 	: genValues(0.140, 0.170, 0.005, 3),
		'60_days' 	: genValues(0.150, 0.175, 0.005, 3),
		'75_days' 	: genValues(0.130, 0.160, 0.005, 3),
		'90_days' 	: genValues(0.075, 0.090, 0.005, 3)
	},
	high_values : {
		'15_days' 	: genValues(0.145, 0.200, 0.005, 3), 
		'30_days' 	: genValues(0.175, 0.200, 0.005, 3), 
		'45_days' 	: genValues(0.175, 0.200, 0.005, 3), 
		'60_days' 	: genValues(0.195, 0.230, 0.005, 3), 
		'75_days' 	: genValues(0.150, 0.175, 0.005, 3), 
		'90_days' 	: genValues(0.150, 0.175, 0.005, 3)
	},
	period_offset : {
		'15_days' 	: genCombos(18, 24, 0.5, 1),
		'30_days' 	: genCombos(16, 19, 0.5, 1),
		'45_days' 	: genCombos(16, 19.5, 0.5, 1), 
		'60_days' 	: genCombos(16.5, 19, 0.5, 1), 
		'75_days' 	: genCombos(11.5, 14.5, 0.5, 1),
