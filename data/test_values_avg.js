module.exports = {
	...
	low_values : {
		...
		'45_days' 	: genValues(0.040, 0.210, 0.01, 3),  //   "
	...
	high_values : {
		...
		'45_days' 	: genValues(0.090, 0.310, 0.01, 3),  //   "
		'60_days' 	: genValues(0.180, 0.330, 0.01, 3),  
		'75_days' 	: genValues(0.180, 0.290, 0.01, 3),  
		'90_days' 	: genValues(0.180, 0.300, 0.01, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 27, 1, 1), // was 0.5
		'45_days' 	: genCombos(12, 29, 1, 1), //   "
