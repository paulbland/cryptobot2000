module.exports = {
	...
	low_values : {
		...
		'90_days' 	: genValues(0.075, 0.105, 0.005, 3)
	},
	high_values : {
		...
		'75_days' 	: genValues(0.165, 0.200, 0.005, 3), 
		'90_days' 	: genValues(0.160, 0.200, 0.005, 3)
	},
	period_offset : {
		'15_days' 	: genCombos(19, 23, 0.5, 1), 
		'30_days' 	: genCombos(16, 20, 0.5, 1), 
		'45_days' 	: genCombos(17, 20, 0.5, 1),  
		'60_days' 	: genCombos(16.5, 19, 0.5, 1),  
		'75_days' 	: genCombos(9, 14, 0.5, 1),
		'90_days' 	: genCombos(9.5, 14, 0.5, 1)
	}
}	
