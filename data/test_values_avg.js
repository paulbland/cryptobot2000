module.exports = {
	...
	low_values : {
		'15_days' 	: genValues(0.005, 0.040, 0.005, 3), 
		'30_days' 	: genValues(0.030, 0.065, 0.005, 3), 
		'45_days' 	: genValues(0.040, 0.085, 0.005, 3), 
		'60_days' 	: genValues(0.090, 0.140, 0.005, 3), 
		'75_days' 	: genValues(0.075, 0.135, 0.005, 3), 
		'90_days' 	: genValues(0.105, 0.135, 0.005, 3), 
		'105_days' 	: genValues(0.060, 0.105, 0.005, 3),
		'120_days' 	: genValues(0.065, 0.100, 0.005, 3), 
		'135_days' 	: genValues(0.040, 0.095, 0.005, 3),
		'150_days' 	: genValues(0.030, 0.080, 0.005, 3),
		'165_days' 	: genValues(0.025, 0.065, 0.005, 3),
	...
	high_values : { 
		...
		'30_days' 	: genValues(0.040, 0.075, 0.005, 3),  
		'45_days' 	: genValues(0.045, 0.075, 0.005, 3),  
		'60_days' 	: genValues(0.000, 0.050, 0.005, 3),  
		'75_days' 	: genValues(0.000, 0.025, 0.005, 3),  
		'90_days' 	: genValues(0.015, 0.055, 0.005, 3),  
		'105_days' 	: genValues(0.030, 0.090, 0.005, 3), 
		'120_days' 	: genValues(0.060, 0.105, 0.005, 3),  
		'135_days' 	: genValues(0.060, 0.095, 0.005, 3),  
		'150_days' 	: genValues(0.015, 0.075, 0.005, 3),  
		'165_days' 	: genValues(0.020, 0.055, 0.005, 3),  
	...
	// genCombos(2, 24, 1, 1),
	period_offset : {
		'15_days' 	: genCombos(3.5, 8.5, 0.5, 1),
		'30_days' 	: genCombos(3.5, 9, 0.5, 1),
		'45_days' 	: genCombos(15, 21.5, 0.5, 1),
		'60_days' 	: genCombos(34, 40, 0.5, 1),
		'75_days' 	: genCombos(36, 43.5, 0.5, 1),
		'90_days' 	: genCombos(36.5, 40.5, 0.5, 1),
		'105_days' 	: genCombos(22, 27.5, 0.5, 1),
		'120_days' 	: genCombos(14.5, 21, 0.5, 1),
		'135_days' 	: genCombos(10, 18.5 , 0.5, 1),
		'150_days' 	: genCombos(6.5, 14, 0.5, 1),
		'165_days' 	: genCombos(2.5, 7, 0.5, 1),
