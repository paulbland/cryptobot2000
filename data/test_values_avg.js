module.exports = {
	...
	low_values : {
		'15_days' 	: genValues(0.115, 0.140, 0.005, 3), 
		'30_days' 	: genValues(0.145, 0.175, 0.005, 3), 
		'45_days' 	: genValues(0.155, 0.180, 0.005, 3), 
		'60_days' 	: genValues(0.150, 0.180, 0.005, 3), 
		'75_days' 	: genValues(0.120, 0.145, 0.005, 3),
		'90_days' 	: genValues(0.075, 0.095, 0.005, 3)
	},
	high_values : {
		'15_days' 	: genValues(0.130, 0.165, 0.005, 3), 
		'30_days' 	: genValues(0.170, 0.205, 0.005, 3),  
		'45_days' 	: genValues(0.175, 0.200, 0.005, 3),  
		'60_days' 	: genValues(0.185, 0.235, 0.005, 3), 
		'75_days' 	: genValues(0.150, 0.180, 0.005, 3), 
		'90_days' 	: genValues(0.150, 0.180, 0.005, 3)
	},
	period_offset : {
		'15_days' 	: genCombos(19, 27, 0.5, 1), 
		'30_days' 	: genCombos(17, 20, 0.5, 1), 
		'45_days' 	: genCombos(16, 19.5, 0.5, 1),  
		'60_days' 	: genCombos(16.5, 19.5, 0.5, 1),  
		'75_days' 	: genCombos(10.5, 13.5, 0.5, 1),
		'90_days' 	: genCombos(10.5, 15, 0.5, 1)
	}
}	
