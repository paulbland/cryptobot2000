module.exports = {
	...
	high_values : {
		'15_days' 	: genValues(0.180, 0.230, 0.005, 3), 
		'30_days' 	: genValues(0.175, 0.200, 0.005, 3), 
		'45_days' 	: genValues(0.180, 0.205, 0.005, 3), 
		'60_days' 	: genValues(0.180, 0.205, 0.005, 3), 
		'75_days' 	: genValues(0.160, 0.175, 0.005, 3), 
		'90_days' 	: genValues(0.160, 0.175, 0.005, 3)
	},
	period_offset : {
		'15_days' 	: genCombos(14.5, 17.5, 0.5, 1),
		'30_days' 	: genCombos(16, 19, 0.5, 1),
		'45_days' 	: genCombos(16.5, 18.5, 0.5, 1), 
		'60_days' 	: genCombos(16.5, 18.5, 0.5, 1), 
