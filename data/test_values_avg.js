module.exports = {
	...
	low_values : {
		'30_days' 	: genValues(0.050, 0.170, 0.01, 3),  // was 0.005 (only shown to be xx -> 0.0165) (max ever was 0.160)
		'45_days' 	: genValues(0.045, 0.180, 0.01, 3),  // was 0.005
		'60_days' 	: genValues(0.120, 0.180, 0.005, 3), 
		'75_days' 	: genValues(0.140, 0.185, 0.005, 3), 
		'90_days' 	: genValues(0.130, 0.200, 0.005, 3)  
	},
	high_values : {
		'30_days' 	: genValues(0.095, 0.275, 0.01, 3),  // was 0.005
		'45_days' 	: genValues(0.120, 0.280, 0.01, 3),  // was 0.005
		'60_days' 	: genValues(0.180, 0.275, 0.005, 3),  
		'75_days' 	: genValues(0.180, 0.240, 0.005, 3),  
		'90_days' 	: genValues(0.180, 0.245, 0.005, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 24, 0.5, 1), 
		'45_days' 	: genCombos(13, 24, 0.5, 1), 
		'60_days' 	: genCombos(14.5, 21, 0.5, 1), 
		'75_days' 	: genCombos(15.5, 19.5, 0.5, 1), 	 
