module.exports = {
	...
	low_values : {
		'15_days' 	: genValues(0.100, 0.135, 0.005, 3),
		'30_days' 	: genValues(0.140, 0.180, 0.005, 3), 
		'45_days' 	: genValues(0.145, 0.185, 0.005, 3), 
		'60_days' 	: genValues(0.145, 0.200, 0.005, 3), 
		'75_days' 	: genValues(0.165, 0.205, 0.005, 3),
		'90_days' 	: genValues(0.120, 0.160, 0.005, 3)
	},
	high_values : {
		'15_days' 	: genValues(0.135, 0.185, 0.005, 3), 
		'30_days' 	: genValues(0.165, 0.210, 0.005, 3),  
		'45_days' 	: genValues(0.170, 0.210, 0.005, 3),  
		'60_days' 	: genValues(0.165, 0.210, 0.005, 3), 
		'75_days' 	: genValues(0.185, 0.220, 0.005, 3), 
		'90_days' 	: genValues(0.160, 0.210, 0.005, 3)
	},
	period_offset : {
		'15_days' 	: genCombos(14.5, 18.5, 0.5, 1),
		'30_days' 	: genCombos(15.5, 20.5, 0.5, 1),
		'45_days' 	: genCombos(16.5, 20.5, 0.5, 1),  
		'60_days' 	: genCombos(16, 19.5, 0.5, 1),  
		'75_days' 	: genCombos(14.5, 19, 0.5, 1),
		'90_days' 	: genCombos(8, 12.5, 0.5, 1)
	}
}	
