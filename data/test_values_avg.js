module.exports = {
	...
	low_values : {
		'30_days' 	: genValues(0.050, 0.155, 0.005, 3), 
		'45_days' 	: genValues(0.055, 0.180, 0.005, 3), 
		'60_days' 	: genValues(0.125, 0.175, 0.005, 3), 
		'75_days' 	: genValues(0.150, 0.185, 0.005, 3), 
		'90_days' 	: genValues(0.135, 0.200, 0.005, 3)  
	},
	high_values : {
		'30_days' 	: genValues(0.095, 0.275, 0.005, 3), 
		'45_days' 	: genValues(0.130, 0.280, 0.005, 3), 
		'60_days' 	: genValues(0.180, 0.260, 0.005, 3),  
		'75_days' 	: genValues(0.180, 0.230, 0.005, 3),  
		'90_days' 	: genValues(0.180, 0.235, 0.005, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 24, 0.5, 1), 
		'45_days' 	: genCombos(13, 22.5, 0.5, 1), 
		'60_days' 	: genCombos(14.5, 20.5, 0.5, 1), 
