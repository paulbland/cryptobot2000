module.exports = {
	...
	low_values : {
		'30_days' 	: genValues(0.095, 0.145, 0.005, 3), // done
		'45_days' 	: genValues(0.140, 0.175, 0.005, 3), // done
	...
	high_values : {
		...
		'45_days' 	: genValues(0.205, 0.240, 0.005, 3),  // done
	...
	period_offset : {
		...
		'45_days' 	: genCombos(15.5, 19.5, 0.5, 1), // done
