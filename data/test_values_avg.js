module.exports = {
	...
	high_values : {
		...
		'45_days' 	: genValues(0.110, 0.280, 0.01, 3),  // was 0.005
		'60_days' 	: genValues(0.180, 0.285, 0.005, 3),  
		'75_days' 	: genValues(0.180, 0.250, 0.005, 3),  
		'90_days' 	: genValues(0.180, 0.255, 0.005, 3)   
	},
	period_offset : {
