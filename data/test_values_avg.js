module.exports = {
	...
	low_values : {
		'15_days' 	: genValues(0.105, 0.125, 0.005, 3),
		'30_days' 	: genValues(0.130, 0.155, 0.005, 3),
	...
	high_values : {
		'15_days' 	: genValues(0.150, 0.200, 0.005, 3), 
		'30_days' 	: genValues(0.180, 0.200, 0.005, 3), 
		'45_days' 	: genValues(0.180, 0.200, 0.005, 3), 
		'60_days' 	: genValues(0.200, 0.225, 0.005, 3), 
		'75_days' 	: genValues(0.150, 0.175, 0.005, 3), 
		'90_days' 	: genValues(0.150, 0.175, 0.005, 3)
	},
	period_offset : {
		'15_days' 	: genCombos(18, 23.5, 0.5, 1),
		'30_days' 	: genCombos(16, 18.5, 0.5, 1),
		'45_days' 	: genCombos(16, 19, 0.5, 1), 
