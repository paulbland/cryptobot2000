module.exports = {
	...
	low_values : {
		'30_days' 	: genValues(0.050, 0.160, 0.005, 3), 
		'45_days' 	: genValues(0.050, 0.180, 0.005, 3), 
		'60_days' 	: genValues(0.120, 0.175, 0.005, 3), 
	...
	high_values : {
		...
		'60_days' 	: genValues(0.180, 0.265, 0.005, 3),  
		'75_days' 	: genValues(0.180, 0.230, 0.005, 3),  
		'90_days' 	: genValues(0.180, 0.240, 0.005, 3)   
	},
	period_offset : {
		'30_days' 	: genCombos(17, 24, 0.5, 1), 
		'45_days' 	: genCombos(13, 23, 0.5, 1), 
